...
{
    [HideInInspector] public UnityEventInteger OnPlayerDestroyed = new UnityEventInteger();
    ...
    public void Spawn(Vector3 position, Vector3 forward)
    {
        ...
        GameObject carPrefabToSpawn = playerSelManager.GetPlayerCarPrefab(PlayerID);
